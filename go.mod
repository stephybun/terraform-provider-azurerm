...
require (
	...
	github.com/hashicorp/terraform-plugin-framework v1.16.0-beta.1.0.20250826091022-afb7e09a233a
	...
	github.com/hashicorp/terraform-plugin-sdk/v2 v2.37.1-0.20250826074230-9419032037aa
